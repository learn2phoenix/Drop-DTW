...
from paths import CT_PATH, COIN_PATH, YC_PATH, ARA_PATH, MR_PATH
...
class DataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        train_loader = DataLoader(
            self.train_dataset, batch_sampler=batch_idx_sampler, collate_fn=flatten_batch, num_workers=32
        )
        return train_loader
